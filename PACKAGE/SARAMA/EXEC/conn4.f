...
c        GENERATE THE SURFACE FOR THE MOLECULE.
          ...
          character*3 res(20000),atomrem(1000)
          character*3  atom
...
c----------------------------------------------------
          ...
          do    10    i = 1,20000 
         read(1,20,end=25)atom(i),res(i),ires(i)
     *,x(i),y(i),z(i)
20       format(13x,a3,1x,a3,3x,i3,4x,3f8.3)
         write(88,20)atom(i),res(i),ires(i)
     *,x(i),y(i),z(i)
         iatno = iatno + 1
...
c--------------------------------------------------------
c--------------------------------------------------------
         write(3,50)j,atom(j),ires(j),res(j),nam
50       format(i5,1x,a3,i3,a3,2x,i6)
     ...
     *dotny(k),dotnz(k),(istatus(k,l),l=1,3)
        write(101,591)'ATOM',j,atom(j),res(j),'X',ires(j),
