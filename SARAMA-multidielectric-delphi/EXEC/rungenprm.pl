...
$bur = 1.00;
	...
	{
	$self_field = $dir.'/'.$rt1.$rn.'sf.pdb'; 	# field input 1
	$comp_field = $dir.'/'.$rt1.$rn.'cf.pdb';	# field input 2
	$surf_grid = $dir.'/'.$rt1.$rn.'s.pdb';		# surface grid input 1,2
...
#	$pot1 = $rt1.$rn.'s.pot';		# potential on surface output 1
	$pot1 = 'sf.pot';		# potential on surface output 1
#	$pot2 = $rt1.$rn.'c.pot';		# potential on surface output 2
