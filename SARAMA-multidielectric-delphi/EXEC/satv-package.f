...
c=====================================================
        ...
        do  25 i=1,irtot
        itot=itot+1
        read(3,40,end=25)res1,ires1,ino1
40      format(5x,a3,2x,i6,2x,i6)
...
!===============================================================
          ...
          write(4,588)ires(i),res(i),frac(irsk),sut,sus,sum1


88        format(1x,i5,1x,a3,1x,f7.3,1x,i5,1x,i5,3(1x,f7.3))
588       format(i3,1x,a3,2x,f4.2,3(1x,f8.3))
